...
20.times do |i|
  ...
  location = melinda.practices.first.locations.create(name: name, address: address, phone_number: phone_number, contact: contact, services: service, latitude: lat, longitude: long, staff: staff)
